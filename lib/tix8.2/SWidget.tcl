#
#	$Id: SWidget.tcl,v 1.3 2000/12/24 06:36:53 ioilam Exp $
#
# SWidget.tcl --
#
...
# This must look like a huge pool of unnecessary code here, but it's in fact
# necessary. Contrary to intuition, we can't use built-in geometry managers
# like pack or grid because the scrollbars may be displayed as-needed. If
# we use the built-in geometry managers, we may go into infinite loops
# where the scrollbars are constantly taken on and off.
#
# Don't mess with these procs unless you fully understand what they do.
