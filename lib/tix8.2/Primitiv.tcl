#
#	$Id: Primitiv.tcl,v 1.4 2001/01/11 07:42:52 ioilam Exp $
#
# Primitiv.tcl --
#
...
tixWidgetClassEx tixPrimitive {
    ...
    -configspec {
	{-background background Background [tixGetDefault NORMAL_BG]
        } 
